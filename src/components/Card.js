...
export default function Card(props) {
  ...
  return (
    <div>
      ...
      <div className="card mt-3 bg-secondary" style={{ width: "16rem", maxHeight: "360px" , borderRadius: "40px" }}>
        ...
        <div className="card-body">
          ...
          <div className='container w-100 p-0' style={{ height: "38px" }}>
            ...
            <div className=' d-inline ms-2 h-100 w-20 fs-5 text-light' >
              ₹{finalPrice}/-
            </div>
          </div>
          <hr></hr>
          <button className={`btn btn-danger text-light justify-center ms-2 `} onClick={handleAddToCart}>Add to Cart</button>
