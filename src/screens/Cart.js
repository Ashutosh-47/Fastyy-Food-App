...
export default function Cart() {
  ...
  const handleCheckOut = async () => {
    ...
    let response = await fetch("https://fastyy-foodapp.onrender.com/api/auth/orderData", {
      // credentials: 'include',
  ...
  return (
    <div>
      ...
      <div className='container m-auto mt-5 table-responsive  table-responsive-sm table-responsive-md' >
        ...
        <div>
          <button className='btn bg-primary text-light mt-5 ' onClick={handleCheckOut} > Check Out </button>
        </div>
      </div>
